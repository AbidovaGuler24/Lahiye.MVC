...
namespace OnlineLearning.DAL.Migrations
{
    ...
    [Migration("20250616230856_CafeMenuTable2")]
    partial class CafeMenuTable2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineLearning.Core.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OnlineLearning.Core.Entities.CafeMenuCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CafeMenuCategories");
                });

            modelBuilder.Entity("OnlineLearning.Core.Entities.CafeMenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OnlineLearning.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineLearning.Core.Entities.CafeMenuItem", b =>
                {
                    b.HasOne("OnlineLearning.Core.Entities.CafeMenuCategory", "Category")
                        .WithMany("MenuItems")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
